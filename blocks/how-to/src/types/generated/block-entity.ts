...
export type HowToBlockHasHowToBlockIntroductionLink = { linkEntity: HasHowToBlockIntroduction; rightEntity: HowToBlockIntroduction }

export type HowToBlockHasHowToBlockStepLink = { linkEntity: HasHowToBlockStep; rightEntity: HowToBlockStep }
...
export type HowToBlockOutgoingLinkAndTarget = HowToBlockHasHowToBlockStepLink | HowToBlockHasHowToBlockIntroductionLink

export type HowToBlockOutgoingLinksByLinkEntityTypeId = { "https://blockprotocol.org/@hash/types/entity-type/has-how-to-block-step/v/1": HowToBlockHasHowToBlockStepLink, "https://blockprotocol.org/@hash/types/entity-type/has-how-to-block-introduction/v/1": HowToBlockHasHowToBlockIntroductionLink }
