...
export type ChartBlockHasQueryLink = { linkEntity: HasQuery; rightEntity: Query }

export type ChartBlockOutgoingLinkAndTarget = ChartBlockHasQueryLink

export type ChartBlockOutgoingLinksByLinkEntityTypeId = { "https://blockprotocol.org/@hash/types/entity-type/has-query/v/1": ChartBlockHasQueryLink }
