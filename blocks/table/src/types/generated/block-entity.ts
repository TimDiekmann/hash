...
export type TableBlockHasQueryLink = { linkEntity: HasQuery; rightEntity: Query }

export type TableBlockOutgoingLinkAndTarget = TableBlockHasQueryLink

export type TableBlockOutgoingLinksByLinkEntityTypeId = { "https://blockprotocol.org/@hash/types/entity-type/has-query/v/1": TableBlockHasQueryLink }
