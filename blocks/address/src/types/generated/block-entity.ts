...
export type AddressBlockHasAddressLink = { linkEntity: HasAddress; rightEntity: Address }

export type AddressBlockHasMapImageLink = { linkEntity: HasMapImage; rightEntity: Image }

export type AddressBlockOutgoingLinkAndTarget = AddressBlockHasAddressLink | AddressBlockHasMapImageLink

export type AddressBlockOutgoingLinksByLinkEntityTypeId = { "https://blockprotocol.org/@hash/types/entity-type/has-address/v/1": AddressBlockHasAddressLink, "https://blockprotocol.org/@hash/types/entity-type/has-map-image/v/2": AddressBlockHasMapImageLink }
...
export type BlockEntityOutgoingLinkAndTarget = AddressBlockOutgoingLinkAndTarget
